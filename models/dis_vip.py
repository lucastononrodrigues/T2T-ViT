...
default_cfgs = {
    'disvip_base_patch16_224': _cfg(mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)),
    'disvip_smalltest': _cfg(mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)),
    'disvip_wope_smalltest': _cfg(mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)),
    'disvip_wopesak_base_patch16_224': _cfg(mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)),
    'disvip_wopesak_d14': _cfg(mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)),
    'disvip_7':_cfg(mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)),
    'disvip_10':_cfg(mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)),
    'disvip_12':_cfg(mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)),
    'disvip_14':_cfg(mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)),
    'disvip_19':_cfg(mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)),
    'disvip_24':_cfg(mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)),
}
...
@register_model
def disvip_wope_smalltest(pretrained=False, **kwargs):
...
@register_model
def disvip_smalltest(pretrained=False, **kwargs):
...
@register_model
def disvip_base_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(patch_size=16, embed_dim=768, depth=12, num_heads=12,disentangled=True,**kwargs)
    model.default_cfg = default_cfgs['disvip_base_patch16_224']
    if pretrained:
        load_pretrained(
            model, num_classes=model.num_classes, in_chans=kwargs.get('in_chans', 3))
    return model
...
@register_model
def disvip_wopesak_base_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformerWOPE(patch_size=16, embed_dim=768, depth=12, num_heads=12,disentangled=True,**kwargs)
    model.default_cfg = default_cfgs['disvip_wopesak_base_patch16_224']
    if pretrained:
        load_pretrained(
            model, num_classes=model.num_classes, in_chans=kwargs.get('in_chans', 3))
    return model
...
#Experiments based on T2T-vip

@register_model
def disvip_7(pretrained=False, **kwargs):
    model = VisionTransformerWOPE(patch_size=16, embed_dim=256, depth=7, num_heads=4, mlp_ratio=2., **kwargs)
    model.default_cfg = default_cfgs['disvip_7']
    if pretrained:
        load_pretrained(
            model, num_classes=model.num_classes, in_chans=kwargs.get('in_chans', 3))
    return model
